...
void XMLHandler::characters(const   XMLCh* const		chars, const XMLSize_t length)
{
    ...
    if(found==true && strcmp(message,"sÃ¤r")==0) sar++;
    ...
    if(found==true && strcmp(message,"frÃ¥getecken")==0) fragetecken++;
...
{
	if(sar==55) cout << "Category SÃ¤rskrivning:\t\t\t OK" << endl;
	else cout << "Category SÃ¤rskrivning:\t\t\t FAILED: "<<sar<<"/55"<< endl;
	...
	if(fragetecken==5) cout << "Category FrÃ¥getecken:\t\t\t OK" << endl;
	else cout << "Category FrÃ¥getecken:\t\t\t FAILED: "<<fragetecken<<"/5" << endl;
	...
	if(ordbi==3) cout << "Category OrdfÃ¶ljd i bisats:\t\t OK" << endl;
	else cout << "Category OrdfÃ¶ljd i bisats:\t\t FAILED: "<<ordbi<<"/3" << endl;
	if(ordind==2) cout << "Category OrdfÃ¶ljd i indirekt frÃ¥gesats:\t OK" << endl;
	else cout << "Category OrdfÃ¶ljd i indirekt frÃ¥gesats:\t FAILED: "<<ordind<<"/2" << endl;
